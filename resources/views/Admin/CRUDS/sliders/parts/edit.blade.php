...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('sliders.update',$slider->id)}}">
    ...
    <div class="row g-4">
        <div class="form-group">
            ...
            <input type="file" class="dropify" name="image" data-default-file="{{get_file($slider->image)}}" accept="image/*"/>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title_ar" required type="text" class="form-control form-control-solid" placeholder=" " name="title_ar" value="{{$slider->title_ar}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title_en" required type="text" class="form-control form-control-solid" placeholder=" " name="title_en" value="{{$slider->title_en}}"/>
        </div>
