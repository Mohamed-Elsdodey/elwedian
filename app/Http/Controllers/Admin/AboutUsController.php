...
class AboutUsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $admins = AboutUs::query()->where('type','about_us')->latest();
        ...
        return view('Admin.CRUDS.aboutUs.index');
    }
    ...
    public function create()
    {
        ...
        return view('Admin.CRUDS.aboutUs.parts.create');
    }
    ...
    public function edit( $id)
    {
        ...
        return view('Admin.CRUDS.aboutUs.parts.edit', compact('row'));
